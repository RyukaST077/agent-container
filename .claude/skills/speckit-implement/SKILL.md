...
5. Parse tasks.md structure and extract:
   - **Task phases** (as generated by `/speckit-tasks`): Setup, Foundational (blocking prerequisites), one phase per user story (P1, P2, P3... in priority order), Polish & Cross-Cutting Concerns, and Final Verification (E2E) — always the last phase
...
7. Implementation execution rules (mirrors the phase structure `/speckit-tasks` generates):
