...
get_repo_root() {
    ...
    # Final fallback: git repo root, else current directory. Callers are
    # documented to run these scripts from the repo root. (A script-location
    # fallback would assume the .specify/scripts/bash/ depth and resolve to
    # the wrong directory for skill-bundled copies.)
